...
use rustycommit::auth::token_storage::{TokenStorage, store_tokens, get_tokens, delete_tokens, has_valid_token};
...
fn test_provider_specific_configurations() {
    ...
    assert_eq!(loaded_azure.api_url.as_deref(), Some("https://test.openai.azure.com"));
}
